...
- [Singularities in global pluripotential theory](Lectures/SGPT_final.pdf). This is (almost) the final version, accepted by the Springer LNM series (despite the great ostabcles created by a single referee). I will remove this link after its formal publication. Please download it if you are in need.
